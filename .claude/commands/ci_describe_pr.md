...
1. **Read the PR description template:**
   - First, check if `.github/workflows/pull_request_template.md` exists
   - If it doesn't exist, inform the user that their `humanlayer thoughts` setup is incomplete and they need to create a PR description template at `.github/workflows/pull_request_template.md`
